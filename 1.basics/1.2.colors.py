...
my_gray3 = np.zeros((height, width, 3), np.uint8) # sepia is not a grayscale
...
for h in range(height):
    ...
    for w in range(width):
        ...
        my_gray1[h,w] = 0.333 * img[h,w,0] + 0.333 * img[h,w,1] + 0.333 * img[h,w,2]
        # luminosity formula (CCIR 601) : Y = 0.299 * R + 0.587 * G + 0.114 * B
        my_gray2[h,w] = 0.114 * img[h,w,0] + 0.587 * img[h,w,1] + 0.229 * img[h,w,2]
        # sepia formula - not a grayscale
        # newR = (0.393 * R + 0.769 * G + 0.189 * B)
        # newG = (0.349 * R + 0.686 * G + 0.168 * B)
        # newB = (0.272 * R + 0.534 * G + 0.131 * B)
        newR = 0.189 * img[h,w,0] + 0.769 * img[h,w,1] + 0.393 * img[h,w,2]
        newG = 0.168 * img[h,w,0] + 0.686 * img[h,w,1] + 0.349 * img[h,w,2]
        newB = 0.131 * img[h,w,0] + 0.534 * img[h,w,1] + 0.272 * img[h,w,2]
